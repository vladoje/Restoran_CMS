...
import { clientRegisterAPI } from "@/app/_lib/userRegisterAPI";
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  if (!res?.ok) {
                    ...
                    router.refresh(); // Prisili Next.js da osvježi keš i middleware prepozna sesiju
                  }
                } catch (e: unknown) {
